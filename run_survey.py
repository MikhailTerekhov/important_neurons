...
# neurons = [0]
# neurons = [0, 1, 2, 3]
# Generated by select_by_importance.py
# 40 features in the middle, mean importance=13.025, and 40 on the top, mean importance=86.75; randomly shuffled
neurons = [62, 712, 812, 384, 87, 768, 217, 283, 769, 603, 754, 6, 527, 811, 485, 447, 581, 153, 459, 359, 39, 292, 636, 744, 800, 1, 774, 704, 336, 143, 33, 231, 761, 816, 89, 385, 114, 590, 202, 810, 148, 446, 750, 570, 617, 616, 803, 789, 795, 123, 472, 813, 188, 791, 605, 46, 53, 106, 97, 185, 785, 329, 139, 141, 301, 665, 720, 67, 140, 166, 705, 726, 395, 310, 718, 692, 775, 57, 588, 776]
...
def save_response():
    ...
    with open(data_fname, 'a') as out_file:
        print(f"{model_name},{layer_name},{neurons[cur_neuron_ind]},"
              f"{question_responses[0]},\"{text_response}\","
              f"{question_responses[1]},{question_responses[2]},{question_responses[3]},{question_responses[4]}",
